...
carImg = pygame.image.load('football.player.png')
gameIcon = pygame.image.load('football.player.png')
...
def crash():
    ...
    TextSurf, TextRect = text_objects("Tackled", largeText)
    ...
    while True:
        ...
        button("Play Again",150,450,100,50,blue,bright_blue,game_loop)
...
def game_intro():
    ...
    while intro:
        ...
        button("Run!",150,450,100,50,blue,bright_blue,game_loop)
        button("Quit",550,450,100,50,bright_red,red,quitgame)
